...
It renames all the occurrences of humanoid_tasks (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the humanoid_tasks folder
        os.rename(
            os.path.join(root_dir_path, "exts", "humanoid_tasks", "humanoid_tasks"),
            os.path.join(root_dir_path, "exts", "humanoid_tasks", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "humanoid_tasks"), os.path.join(root_dir_path, "exts", new_name))
