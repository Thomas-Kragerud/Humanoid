...
class RewardsCfg:
    ...
    pen_dof_torques_l2 = RewTerm(func=mdp.joint_torques_l2, weight=-1.0e-5) # Not in quadruped
    pen_dof_acc_l2 = RewTerm(func=mdp.joint_acc_l2, weight=-2.5e-7)
    pen_action_rate_l2 = RewTerm(func=mdp.action_rate_l2, weight=-0.01)

    # No pen joint power:  pen_joint_powers = RewardTermCfg(func=mdp.joint_powers_l1, weight=-5.0e-4)
    ...
    # -- optional penalties
    pen_flat_orientation_l2 = RewTerm(func=mdp.flat_orientation_l2, weight=0.0)
    pen_dof_pos_limits = RewTerm(func=mdp.joint_pos_limits, weight=0.0)
