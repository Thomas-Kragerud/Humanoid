...
from humanoid_tasks.cfg.quadruped_env_cfg import QuadrupedEnvCfg
from humanoid_tasks.cfg.quadruped_terrains_cfg import (
...
class Go2BlindStairsEnvCfg(Go2BaseEnvCfg):
    def __post_init__(self):
        ...
        print(f" Terrain sub {self.scene.terrain.terrain_generator.sub_terrains}\n")
